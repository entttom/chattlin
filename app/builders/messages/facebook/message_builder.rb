# This class creates both outgoing messages from chattlin and echo outgoing messages based on the flag `outgoing_echo`
# Assumptions
# 1. Incase of an outgoing message which is echo, source_id will NOT be nil,
#    based on this we are showing "not sent from chattlin" message in frontend
...
class Messages::Facebook::MessageBuilder < Messages::Messenger::MessageBuilder
  ...
  def perform
    ...
    ChattlinExceptionTracker.new(e, account: @inbox.account).capture_exception
    true
  end
  ...
  def contact_params
    begin
      ...
      ChattlinExceptionTracker.new(e, account: @inbox.account).capture_exception unless @outgoing_echo
    rescue StandardError => e
      result = {}
      ChattlinExceptionTracker.new(e, account: @inbox.account).capture_exception
    end
