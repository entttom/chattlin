  ...
  describe 'GET /installation/onboarding' do
    context 'when CHATTLIN_INSTALLATION_ONBOARDING redis key is not set' do
      it 'redirects back' do
        expect(::Redis::Alfred.get(::Redis::Alfred::CHATTLIN_INSTALLATION_ONBOARDING)).to eq nil
  ...
  describe 'POST /installation/onboarding' do
    ...
    context 'when onboarding is not successfull' do
      it 'does not deletes the redis key' do
        ...
        post '/installation/onboarding', params: { user: {} }
        expect(::Redis::Alfred.get(::Redis::Alfred::CHATTLIN_INSTALLATION_ONBOARDING)).not_to eq nil
      end
    end
  end
end
