...
export default {
  ...
  computed: {
    ...
    statusActions() {
      const isOpen =
        this.currentChat?.status === maassConstants.STATUS_TYPE.OPEN;
      const isSnoozed =
        this.currentChat?.status === maassConstants.STATUS_TYPE.SNOOZED;
      const isResolved =
        this.currentChat?.status === maassConstants.STATUS_TYPE.RESOLVED;
